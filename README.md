...
- Доработать поддержку буфера обмена
(добавить запоминание разрешения доступа для конкретных клиентов)
- Сделать формат буфера обмена FAR_VerticalBlock_Unicode совместимым с Far for Windows
(если это вообще возможно)
- Выделять буфер APC динамически
(сейчас есть лимит на объем буфера обмена, загружаемого с сервера, ~680Кб)
- Добавить поддержку других типов запросов
(события мышки, уведомления и всё остальное)
- Отображать символы рисования линий без сглаживания
(или можно просто использовать шрифт [Consolas](https://en.wikipedia.org/wiki/Consolas) на Windows :)
